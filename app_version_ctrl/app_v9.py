...
def draw_debug(
    ...
    lines = [
        ...
        "TAB: cycle unit   NUM[1..9]: select   ENTER/E: end turn   L-Click: select/move   R-Click: set/clear INSPECT tile   N: toggle enemy   B: toggle obstacle   R: refill AP (selected)   ESC: quit",
    ]
...
def main() -> int:
    ...
    try:
        ...
        pg.display.set_caption("XCOM Iso — Squad, LOS, Cover & Inspect")
        clock = pg.time.Clock()
        ...
        while running:
            ...
            draw_debug(screen, font, hovered, squad, sel_idx, path_info, tm, inspect_tile, enemies)
